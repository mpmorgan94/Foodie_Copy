...
function DatabaseHandler(functionName, username, password, diet, allergy_array, recipe_id_string , schedule_string, weight, feet, inches, age, sex) {
  ...
  async function saveRecipes(username, recipe_id_string) {
    ...
    await fetch('http://18.218.252.219:3001/saveRecipes', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async function getRecipes(username) {
    ...
    await fetch('http://18.218.252.219:3001/getRecipes', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async function saveBMI(username, weight, feet, inches, age, sex) {
    ...
    await fetch('http://18.218.252.219:3001/saveBMI', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async function getWeight(username) {
    ...
    await fetch('http://18.218.252.219:3001/getWeight', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async function getFeet(username) {
    ...
    await fetch('http://18.218.252.219:3001/getFeet', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async function getInches(username) {
    ...
    await fetch('http://18.218.252.219:3001/getInches', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async function getAge(username) {
    ...
    await fetch('http://18.218.252.219:3001/getAge', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async function getSex(username) {
    ...
    await fetch('http://18.218.252.219:3001/getSex', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
