...
app.post('/userExist', (req, res) => {
  merchant_model.userExist(req.body)
  .then(response => {
    res.status(200).send(response);
  })
  .catch(error => {
...
app.post('/verifyCreds', (req, res) => {
  merchant_model.verifyCreds(req.body)
  .then(response => {
    res.status(200).send(response);
  })
  .catch(error => {
...
app.post('/saveRecipes', (req, res) => {
  merchant_model.saveRecipes(req.body)
  .then(response => {
    res.status(200).send(response);
  })
  .catch(error => {
...
app.post('/getRecipes', (req, res) => {
  merchant_model.getRecipes(req.body)
  .then(response => {
    res.status(200).send(response);
  })
  .catch(error => {
...
app.post('/saveBMI', (req, res) => {
  merchant_model.saveBMI(req.body)
  .then(response => {
    res.status(200).send(response);
  })
  .catch(error => {
...
app.post('/getWeight', (req, res) => {
  merchant_model.getWeight(req.body)
  .then(response => {
    res.status(200).send(response);
  })
  .catch(error => {
...
app.post('/getFeet', (req, res) => {
  merchant_model.getFeet(req.body)
  .then(response => {
    res.status(200).send(response);
  })
  .catch(error => {
...
app.post('/getInches', (req, res) => {
  merchant_model.getInches(req.body)
  .then(response => {
    res.status(200).send(response);
  })
  .catch(error => {
...
app.post('/getAge', (req, res) => {
  merchant_model.getAge(req.body)
  .then(response => {
    res.status(200).send(response);
  })
  .catch(error => {
...
app.post('/getSex', (req, res) => {
  merchant_model.getSex(req.body)
  .then(response => {
    res.status(200).send(response);
  })
  .catch(error => {
